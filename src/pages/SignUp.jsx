...
export default (props) => {
    ...
    let handleChange = (event) => {
        setRegisterState((prev) => {
            if (event.target.id === "fname") {
                ...
                prev.lName = event.target.value;
            } else if (event.target.id === "email") {
                prev.eMail = event.target.value;
            } else if (event.target.id === "pword") {
                prev.pWord = event.target.value;
            }
            return {
                fName: prev.fName,
                lName: prev.lName,
    ...
    async function postData() {
        const response = await fetch('/sign_up', {
            ...
            body: JSON.stringify({
                fName: registerState.fName,
                lName: registerState.lName,
                eMail: registerState.eMail,
                pWord: registerState.pWord
            })
        })
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input id="fname" onChange={handleChange} value={registerState.fName} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" />
                                            </div>
                                        </div>
                                        <div className="w-1/2 px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg" /></div>
                                                <input id="lname" onChange={handleChange} value={registerState.lName} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input id="email" onChange={handleChange} value={registerState.eMail} type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-12">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input id="pword" onChange={handleChange} value={registerState.pWord} type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
