                                ...
                                <div>
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            <button onClick={() => {
                                                onSubmit()
                                            }} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">SIGN IN NOW</button>
                                            <button onClick={() => {
                                                onRegister()
                                            }} className="mt-5 block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
